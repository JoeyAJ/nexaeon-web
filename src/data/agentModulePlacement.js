...
export const MODULE_AGENT_ENTRY_COPY = Object.freeze({
  zh: {
    ...
    orchestratorDescription: 'NexAeon Orchestrator 將公開任務整理為 proposed 計畫，且僅能在伺服器驗證使用者明確確認後建立一筆 Action Center 草稿。',
  ...
  ko: {
    ...
    orchestratorDescription: 'NexAeon Orchestrator는 공개 작업을 proposed 계획으로 정리하며 서버가 사용자의 명시적 확인을 검증한 후에만 Action Center 초안 하나를 생성할 수 있습니다.',
  ...
  en: {
    ...
    orchestratorDescription: 'NexAeon Orchestrator organizes public tasks into proposed plans and can create one Action Center draft only after explicit server-verified confirmation.',
