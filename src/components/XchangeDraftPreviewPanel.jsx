...
export default function XchangeDraftPreviewPanel({ lang }) {
  ...
  function beginRevision(editMode) {
    ...
    setRevision({ open: true, editMode, targetPath, instruction: '', replacementText: editMode.startsWith('edit_') ? JSON.stringify(currentValue, null, 2) : '' });
  }
  ...
  function updateRevisionTarget(targetPath) {
    ...
    setRevision((current) => ({ ...current, targetPath, replacementText: current.editMode.startsWith('edit_') ? JSON.stringify(currentValue, null, 2) : '' }));
  }
