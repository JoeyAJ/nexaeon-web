...
const ROLE_DETAIL_CONTENT = {
  zh: {
    common: {
      roleDetailLabel: 'Role Detail Pages v1',
      backHome: '返回首頁',
    ...
    roles: {
      students: {
        ...
        problems: [
          '不知道如何正確使用 AI 學習',
          'Prompt 能力不足，容易得到表面答案',
          '缺少個別化回饋與學習路徑',
        ],
        solutions: [
          'AI Tutor 個別化輔助',
          'Prompt Engineering 基礎訓練',
          '學習風格與任務回饋',
        ],
        capabilities: [
          'AI Tutoring Lab',
  ...
  ko: {
    ...
    roles: {
      ...
      enterprise: {
        ...
        description: 'AI, ESG, EdTech, 자동화 시나리오를 하나의 협력형 솔루션으로 통합합니다.',
        problems: [
          'AI 적용이 개념 단계에서 멈추기 쉬움',
          'ESG, EdTech, 자동화 시나리오를 묶는 통합안이 부족함',
          '저비용 MVP 검증 방식이 부족함',
        ],
        solutions: [
          'AI Agent Prototype',
