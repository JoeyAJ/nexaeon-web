const CONTENT = {
  zh: {
    ...
    hero: {
      ...
      sub: 'NexAeon 是一座嚴謹且具前瞻性的 AI 數位研究所。\n我們不只討論 AI 概念，而是把 AI 技術、學習理論與管理知識，轉化為可操作的教育工具、研究流程與校園管理系統。',
      cta1: '進入 Research Roadmap',
      cta2: '查看 Demo / MVP',
      scrollCue: '向下滑動，查看 Research × Practice 如何互相推進',
      dualLabel: '雙螺旋敘事',
  ...
  en: {
    ...
    hero: {
      ...
      titleSerifSub: 'A Digital Institute',
      titleSans: 'for the Age of AI',
      sub: 'NexAeon is a rigorous, forward-looking AI digital institute.\nIt does not stop at AI concepts: it turns AI technology, learning theory, and management knowledge into usable education tools, research workflows, and campus management systems.',
      cta1: 'Enter the Research Roadmap',
      cta2: 'View Demo / MVP',
      scrollCue: 'Scroll to see how Research × Practice reinforce each other',
      dualLabel: 'Dual-helix narrative',
      dualTitle: 'Research × Practice',
  ...
  ko: {
    ...
    hero: {
      ...
      titleSerifSub: 'A Digital Institute',
      titleSans: 'for the Age of AI',
      sub: 'NexAeon은 엄밀하고 미래지향적인 AI 디지털 연구소입니다.\nAI 개념을 말하는 데서 멈추지 않고, AI 기술·학습 이론·경영 지식을 작동 가능한 교육 도구, 연구 프로세스, 캠퍼스 관리 시스템으로 전환합니다.',
      cta1: 'Research Roadmap 보기',
      cta2: 'Demo / MVP 보기',
      scrollCue: '스크롤하여 Research × Practice가 서로를 강화하는 흐름을 보기',
      dualLabel: '이중 나선 서사',
      dualTitle: 'Research × Practice',
