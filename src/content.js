const CONTENT = {
  zh: {
    ...
    hero: {
      ...
      sub: '這不是一般 AI SaaS 首頁，而是一座可走入的數位研究所。\n研究、教學與知識節點正在同步生長，邀請你向下探索。',
      cta1: '進入研究所',
      cta2: '先看研究方向',
      scrollCue: '向下滑動，進入研究所',
  ...
  en: {
    ...
    hero: {
      ...
      titleSerifSub: 'A Digital Institute',
      titleSans: 'for the Age of AI',
      sub: 'Not another AI SaaS landing page, but an institute you can enter.\nResearch, teaching, and knowledge nodes are alive here, ready below the fold.',
      cta1: 'Enter the Institute',
      cta2: 'Preview Research',
      scrollCue: 'Scroll to enter the Institute',
  ...
  ko: {
    ...
    hero: {
      ...
      titleSerifSub: 'A Digital Institute',
      titleSans: 'for the Age of AI',
      sub: '일반적인 AI SaaS 랜딩이 아니라, 들어갈 수 있는 디지털 연구소입니다.\n연구·교육·지식 노드가 함께 살아 움직이며, 아래로 이어집니다.',
      cta1: '연구소로 입장',
      cta2: '연구 방향 먼저 보기',
      scrollCue: '스크롤하여 연구소 입장',
