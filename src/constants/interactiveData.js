export const INTERACTIVE_CONTENT = {
  zh: {
    ...
    knowledge: {
      ...
      categories: [
        { key: 'all', label: '全部' },
        { key: 'ai-education', label: 'AI Education' },
    ...
    contact: {
      ...
      title: '聯絡合作',
      description: '歡迎討論 AI 教育、研究共創與課程合作，直接寄信或複製 email 即可開始。',
  ...
  en: {
    ...
    contact: {
      eyebrow: 'Contact & Collaboration',
      title: 'Contact',
      description: 'For AI education, research collaboration, or curriculum co-creation, email directly or copy the address below.',
      email: 'AJ_Joey@nexaeon.studio',
  ...
  ko: {
    ...
    contact: {
      eyebrow: 'Contact & Collaboration',
      title: '협업 문의',
      description: 'AI 교육, 연구 협업, 커리큘럼 공동 설계는 아래 이메일로 바로 문의해 주세요.',
      email: 'AJ_Joey@nexaeon.studio',
      mailtoCta: '이메일 보내기',
      copyCta: '이메일 복사',
