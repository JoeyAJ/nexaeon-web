...
import { readAdminSession, requireAdminCsrf } from '../../../lib/agent/adminSession.js';
import { isAllowedBrowserOrigin } from '../../../lib/agent/chatRuntime.js';
...
export default async function handler(req, res) {
  return handleExplorerWebSearchDiagnostic(req, res);
}
