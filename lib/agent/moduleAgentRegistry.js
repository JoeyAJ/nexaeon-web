...
export const MODULE_AGENT_REGISTRY = Object.freeze({
  identity: Object.freeze({
    id: 'identity', name: { zh: '身份 Agent', ko: '아이덴티티 Agent', en: 'Identity Agent' },
  ...
  research: Object.freeze({
    id: 'research', name: { zh: '研究 Agent', ko: '리서치 Agent', en: 'Research Agent' },
  ...
  coaching: Object.freeze({
    id: 'coaching', name: { zh: '教練 Agent', ko: '코칭 Agent', en: 'Coaching Agent' },
  ...
  knowledge: Object.freeze({
    id: 'knowledge', name: { zh: '知識 Agent', ko: '지식 Agent', en: 'Knowledge Agent' },
  ...
  prototype: Object.freeze({
    id: 'prototype', name: { zh: '原型 Agent', ko: '프로토타입 Agent', en: 'Prototype Agent' },
  ...
  action: Object.freeze({
    id: 'action', name: { zh: '行動 Agent', ko: '액션 Agent', en: 'Action Agent' },
