  ...
  type: 'object', additionalProperties: false, required: ['results'], properties: {
    results: {
      type: 'array', maxItems: 10, items: {
        type: 'object', additionalProperties: false, required: ['title', 'url', 'snippet', 'publishedAt', 'source'], properties: {
          title: textField(500), url: { ...textField(2000), format: 'web-url' }, snippet: textField(5000),
          publishedAt: { type: 'string', format: 'iso-date', nullable: true }, source: textField(500),
          score: { type: 'number', minimum: 0, maximum: 1 }, rawContent: textField(20_000),
        },
      },
    },
  },
...
export const TOOL_REGISTRY = Object.freeze([
  ...
  n8nTool({
    ...
    inputSchema: { type: 'object', additionalProperties: false, required: ['query'], properties: {
      query: textField(1000), maxResults: { type: 'integer', minimum: 1, maximum: 10 }, language: { enum: ['zh', 'ko', 'en'] },
    } },
