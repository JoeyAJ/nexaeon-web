...
export async function handleAgentChatRequest(req, res, deps = {}) {
  ...
  const { query, lang, moduleFilter, history, currentRoute, currentModule } = validated.value;
  executionPlan = createAgentExecutionPlan({ query, currentRoute, currentModule, history });
