import {
  ...
  NETWORKER_ALLOWED_CAPABILITIES,
...
export const AGENT_CAPABILITY_POLICY = Object.freeze({
  ...
  orchestratorAllowedCapabilities: ORCHESTRATOR_ALLOWED_CAPABILITIES,
  networkerAllowedCapabilities: NETWORKER_ALLOWED_CAPABILITIES,
