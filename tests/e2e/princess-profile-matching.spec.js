...
const profiles = [
  { key: 'home', route: '/', accessory: 'none' },
  { key: 'identity', route: '/identity/profile', accessory: 'none' },
  { key: 'research', route: '/research/topic', accessory: 'none' },
  { key: 'coaching', route: '/teaching/course', accessory: 'academic-cap' },
  { key: 'knowledge', route: '/knowledge-lab/resource', accessory: 'none' },
  { key: 'prototype', route: '/projects/demo', accessory: 'none' },
  { key: 'action', route: '/field-lab/action', accessory: 'none' },
  { key: 'navigator', route: '/identity/nexaeon-navigator', accessory: 'none' },
];
